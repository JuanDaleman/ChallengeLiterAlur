package com.aluracursos.literaturachallenge.servicios;
...
public class Menus {
    ...
    public void mostrarMenus(String tipo) {
        ...
        if (tipo.equalsIgnoreCase("idiomas")) {
            ...
            File lenguajes = new File("src/main/java/com/aluracursos/literaturachallenge/services/lenguajesAcep.txt");
            String contenido;
